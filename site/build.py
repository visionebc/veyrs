...
def _inline(text):
    ...
    # Code spans are set aside first, so an asterisk inside one is never
    # taken for emphasis, and restored last.
    codes = []
    ...
    # Bold may contain italics (`**from the *last* run**`): `[^*]+` refused
    # those and left the asterisks on the page.
